...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        //    //builder.Services.AddScoped<IApplicationDbContext, InMemoryStudentRepository>();


        //    builder.Services.AddDbContext<IApplicationDbContext, SQLStudentRepository>(options =>
        //        options.UseNpgsql(builder.Configuration.GetConnectionString("StudentManagementConnectionStrings")));
